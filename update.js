...
const wranglerCode = `name = "awangbotv3"
main = "src/index.js"
...
const indexCode = `import { Hono } from 'hono';
...
fs.writeFileSync("wrangler.toml", wranglerCode);
fs.writeFileSync("src/index.js", indexCode);
console.log("SUCCESS: Fail wrangler.toml & src/index.js telah berjaya dikemas kini!");
